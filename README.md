...
```bash
pipx install https://tokentrick.com/downloads/token_trick_client-0.16.0.tar.gz
...
```bash
pipx install --force https://tokentrick.com/downloads/token_trick_client-0.16.0.tar.gz
```
